...
// Let's Dp[n][is] — number of ways with length equals to n in k-tree, where if is = 1 — there is 
// exists edge with length at least d, is = 0 — lengths of all edges less then d.
