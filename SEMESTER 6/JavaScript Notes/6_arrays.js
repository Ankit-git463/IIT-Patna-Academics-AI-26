...
// These both gives undefined as output coz the indices are not valid
...
// nums.forEach( (curr) => {console.log(curr)}); 
// console.log();
// curr -> it is the current element of the array 
// index -> it is the index of the curr element 
// arr -> it is the third parameter  it is the curr array 
...
//? 1: find Method: The find method is used to find the first element in an array that satisfies a provided testing function. 
...
//* 3:  filter Method: The filter method crea/
//? filter(callbackFn)
